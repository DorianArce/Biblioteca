...
public class Usuarios extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Apellidos", "DNI", "Domicilio", "Poblacion", "Provincia", "Fecha N."
            }
        ) {
    ...
    private void BBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BBuscarActionPerformed
        try {
            ...
            model.setRowCount(0);
            dao.listar(BUsuario.getText()).forEach((u) -> model.addRow(new Object[]{u.getId(), u.getNombre(), u.getApellidos(), u.getDNI(), u.getDomicilio(), u.getPoblacion(),u.getProvincia(),u.getF_Nacimiento()}));
        } catch (Exception e) {
    ...
    private void BNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BNuevoActionPerformed
        Dashboard.ShowJPanel(new SUsuarios());
    ...
    private void BEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BEditarActionPerformed
        if (jTable1.getSelectedRow() > -1) {
            try {
                ...
                DAOUsuarios dao = new DAOUsuariosIMPL();
                Dashboard.ShowJPanel(new SUsuarios(dao.getUserById(userId)));
            } catch (Exception e) {
                System.out.println(e.getMessage());
            }
        } else {
    ...
    private void initStyles() {
        ...
        BUsuario.putClientProperty("JTextField.placeholderText", "Ingrese el nombre de usuario a buscar.");
    }
    ...
    private void loadUsuarios() {
        try{
            DAOUsuarios dao = new DAOUsuariosIMPL();
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            dao.listar("").forEach((u) -> model.addRow(new Object[]{u.getId(),u.getNombre(),u.getApellidos(),u.getDNI(),u.getDomicilio(),u.getPoblacion(),u.getProvincia(),u.getF_Nacimiento()}));
        }catch(Exception e){
            System.out.println(e.getMessage());
            javax.swing.JOptionPane.showMessageDialog(this, "Ha ocurrido un error al registrar al usuario. \n", "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
            return; }
    }
}
